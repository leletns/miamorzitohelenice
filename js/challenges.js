...
const PHRASES = {
  ...
  rocinha: [
    'De ladeira em ladeira, de laje em laje: contigo qualquer caminho é casa. 🏘️',
...
const THEME_NAMES = {
  viaparque: 'Via Parque 🛍️',
  cinema: 'Cinema New York 🎬',
...
const PHOTOS = [
  { src: 'assets/photos/p01.jpg', caption: 'Nós duas, do jeitinho que eu amo 💕' },
  ...
  { src: 'assets/photos/p04.jpg', caption: 'Deitadas no banquinho, vendo o mundo passar 🌃' },
  { src: 'assets/photos/p05.jpg', caption: 'Festa, luz rosa e a gente 🎡' },
  { src: 'assets/photos/p06.jpg', caption: 'Acordar do seu lado é meu presente diário ☀️' },
  { src: 'assets/photos/p07.jpg', caption: 'Céu azul com gostinho de beijo seu ☁️' },
  { src: 'assets/photos/p08.jpg', caption: 'Apertadinha em você é onde eu moro 🫂' },
  { src: 'assets/photos/p09.jpg', caption: 'Qualquer sofá vira lar contigo 🛋️' },
...
const BOARD_CUTE = [
  ...
  'Cante um trechinho de Pupila pra ela. 🎶',
  ...
  'Diga qual é o cheirinho dela que você mais ama. 🌸',
  'Conte um sonho que você quer realizar com ela. 🌠',
  'Imite a gatinha dela. Miau obrigatório. 🐱',
...
const BOARD_SPICY = [
  ...
  'Massagem de 1 minuto onde ela escolher. 💆‍♀️',
  ...
  'Cafuné de 1 minuto, do jeitinho que ela gosta. 🫦',
...
const BOARD_LUCK = [
  ...
  { text: 'Olhinhos de jabuticaba hipnotizaram o dado: jogue de novo! 🍇', again: true },
  { text: 'Vento da praia à noite: avance 3 casas! 🌊', move: 3 },
  { text: 'Parou pra comprar McFlurry: volte 1 casa (valeu a pena). 🍦', move: -1 },
  { text: 'A gatinha deitou no tabuleiro: todo mundo fica onde está, mas vocês se beijam. 🐈‍⬛', move: 0 },
];
